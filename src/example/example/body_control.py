...
from ros_robot_controller_msgs.msg import BuzzerState, MotorsState, MotorState, SetPWMServoState, PWMServoState
...
class BodyControlNode(Node):
    def __init__(self, name):
        ...
        self.servo1 = self.servo_data['servo1'] - 450
        ...
        self.pwm_controller([1, self.servo1], [2, self.servo2])
