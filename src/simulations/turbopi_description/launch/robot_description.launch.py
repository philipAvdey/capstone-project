...
def generate_launch_description():
    ...
    if compiled == 'True':
        turbopi_description_package_path = get_package_share_directory('turbopi_description')
    else:
        turbopi_description_package_path = '/home/ubuntu/ros2_ws/src/simulations/turbopi_description'
    urdf_path = os.path.join(turbopi_description_package_path, 'urdf/turbopi.xacro')
    rviz_config_file = os.path.join(turbopi_description_package_path, 'rviz/view.rviz')
    ...
    rviz_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(turbopi_description_package_path, 'launch', 'rviz.launch.py')),
